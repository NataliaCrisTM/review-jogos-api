...
const regrasReview = [
  body('gameId')
    ...
    .isMongoId().withMessage('O gameId deve ser um ID válido.'),
...
const regraId = [
  param('id')
    .isMongoId().withMessage('O id informado não é um ID válido.'),
];

const regraGameId = [
  param('gameId')
    .isMongoId().withMessage('O gameId informado não é um ID válido.'),
];
